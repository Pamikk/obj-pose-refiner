...
def extract_one_scene_textured_kp3ds(args, color, depth, o2c_pose, i_cam):
    ...
    dpt_xyz = pcl_utils.dpt2cld(depth, K, 1.0)
    ...
    bgr_kp = bgr.copy()
    kps_2d = pcl_utils.project_p3ds(kp_xyz, K=K, scale_m=1.0)
    bgr_kp = visualization_utils.draw_p2ds(bgr_kp, kps_2d, color=(0, 255, 0))
